...
#define MAX_PROTOCOLS 5					// How many protocols can be used, Raw USB, Modbus RTU, Modbus TCP, SAE J1939 etc..
...
#define MAX_C_STRING_EXTRA_LEN 2048		// Max char* length for function values

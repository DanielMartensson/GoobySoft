...
extern inline const std::vector<std::string> FUNCTION_NAMES_ADL400 = { "Read volt A", "Read volt B", "Read volt C", "Read current A", "Read current B", "Read current C", "Read frequency", "Read volt AB", "Read volt AC", "Read volt CB", "Total active power", "Total reactive power", "Total apparent power", "Total power factor"};
